...
The plugin creates a shorter link for every blog post, so instead of `http://kovshenin.com/wordpress/plugins/twitter-friendly-links/` you can use `http://kovshenin.com/712`. Sweet, huh?
